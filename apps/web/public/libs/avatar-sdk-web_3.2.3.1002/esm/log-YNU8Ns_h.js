function t(t, r, n) {
  return (
    ...
    (function (t, e) {
      ...
      return h(t);
    })(t, e() ? Reflect.construct(r, n || [], f(t).constructor) : r.apply(t, n))
  );
}
function e() {
  try {
...
function r() {
  ...
  var O = Object.getPrototypeOf,
    j = O && O(O(N([])));
  j && j !== n && o.call(j, c) && (E = j);
  var S = (b.prototype = g.prototype = Object.create(E));
  function x(t) {
  ...
  function L(e, r, n) {
    ...
    return function (i, a) {
      ...
      for (n.method = i, n.arg = a; ;) {
        ...
        var f = h(e, r, n);
        if ('normal' === f.type) {
          if (((o = n.done ? v : y), f.arg === m)) continue;
  ...
  return (
    ...
    (w.displayName = s(b, f, 'GeneratorFunction')),
...
('function' == typeof SuppressedError && SuppressedError,
  (function (t) {
    ((t.InvalidParam = 'InvalidParam'),
      (t.InvalidResponse = 'InvalidResponse'),
      (t.ContextError = 'ContextError'),
      (t.InlineError = 'InlineError'),
      (t.NetworkError = 'NetworkError'),
      (t.ConnectError = 'ConnectError'),
      (t.InvalidConnect = 'InvalidConnect'),
      (t.MediaError = 'MediaError'),
      (t.UserMediaError = 'UserMediaError'));
  })(O || (O = {})));
var j,
  S,
  x,
  ...
  I = (function (e) {
    ...
    return (u(r, l(Error)), c(r));
  })(),
  A = {
    ParamMissing: { code: '600000', message: '必要参数缺失' },
    InvalidServerError: { code: '600002', message: '无效的ServerUrl' },
    NetworkError: { code: '600003', message: '连接异常' },
    InvalidResponse: { code: '600004', message: '无效的响应' },
    UnknownError: { code: '999999', message: '未知错误' }
  },
  N = {
  ...
  T = {
    SecurityError: { code: '800000', message: '不支持的环境' },
    NotFoundError: { code: '800001', message: '未找到指定约束的设备' },
    NotAllowedError: { code: '800002', message: '设备访问权限异常/无法请求使用源设备' },
    NotReadableError: {
      code: '800003',
      message: '暂时无法访问摄像头/麦克风，请确保当前没有其他应用请求访问设备，并重试'
    },
    OverconstrainedError: { code: '800004', message: '无效的设备请求参数' },
    AbortError: { code: '800005', message: '未知原因操作已终止' },
    InvalidStateError: { code: '800006', message: '当前页面未处于激活状态' },
    NotAllowedWithoutGestureError: { code: '800007', message: '页面未发生用户交互，请求被终止' }
  },
  R = 0,
  M = (function () {
    function t(e) {
      ...
      (i(this, t),
        ...
        S.set(this, {}),
        x.set(this, []),
        k.set(this, function (t, e, r) {
          if ('function' != typeof e) throw TypeError('listener must be a function');
          (-1 === b(n, x, 'f').indexOf(t) && b(n, x, 'f').push(t),
            (b(n, S, 'f')[t] = b(n, S, 'f')[t] || []),
            b(n, S, 'f')[t].push({ once: r || !1, fn: e }));
        }),
        L.set(this, function (t, e) {
          var r = b(n, S, 'f')[t],
            o = [];
          (null == r ||
            r.forEach(function (t, r) {
              (t.fn.apply(null, e), t.once && o.unshift(r));
            }),
            null == o ||
        ...
        E(this, j, null !== (r = null == e ? void 0 : e.emitDelay) && void 0 !== r ? r : R, 'f'));
    }
    return (
      c(t, [
        {
          key: 'on',
          value: function (t, e) {
            return (b(this, k, 'f').call(this, t, e, !1), this);
          }
        },
        {
          key: 'once',
          value: function (t, e) {
            return (b(this, k, 'f').call(this, t, e, !0), this);
          }
        },
        {
          key: 'off',
          value: function (t, e) {
            var r = b(this, x, 'f').indexOf(t);
            if (t && -1 !== r)
              if (e) {
                var n = [],
                  o = b(this, S, 'f')[t];
                (null == o ||
                  ...
                  o.length || (b(this, x, 'f').splice(r, 1), delete b(this, S, 'f')[t]));
              } else (delete b(this, S, 'f')[t], b(this, x, 'f').splice(r, 1));
            return this;
          }
        },
        {
          ...
          value: function () {
            return (E(this, S, {}, 'f'), E(this, x, [], 'f'), this);
          }
        },
        {
          key: 'emit',
        ...
        },
        {
          ...
          value: function (t) {
            for (var e = arguments.length, r = new Array(e > 1 ? e - 1 : 0), n = 1; n < e; n++)
              r[n - 1] = arguments[n];
            b(this, L, 'f').call(this, t, r);
          }
        },
        {
          key: 'destroy',
          value: function () {
            (E(this, S, {}, 'f'), E(this, x, [], 'f'));
          }
        }
      ]),
      t
      ...
      },
      {
        ...
        value: function (t) {
          ...
          if (t >= b(this, _, 'f')) {
            ...
            switch (t) {
              case P.verbose:
                (e = console).log.apply(e, ['[SDK] [VERBOSE] '].concat(c));
                break;
              case P.debug:
                (r = console).log.apply(r, ['[SDK] [DEBUG] '].concat(c));
                break;
              case P.info:
                (n = console).log.apply(n, ['[SDK] [INFO] '].concat(c));
                break;
              case P.warn:
                (o = console).warn.apply(o, ['[SDK] [WARN] '].concat(c));
                break;
              case P.error:
                (i = console).error.apply(i, ['[SDK] [ERROR] '].concat(c));
            }
          }
        }
      }
