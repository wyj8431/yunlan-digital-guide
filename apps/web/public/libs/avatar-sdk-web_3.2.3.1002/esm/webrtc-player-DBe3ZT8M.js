...
import { c as v } from './_commonjs-dynamic-modules-BHR_E30J.js';
import { a as y } from './index-BkA02dev.js';
import { P as g } from './player-BbEl_T77.js';
var C, S;
!(function e(t, r, n) {
  function i(o, s) {
    if (!r[o]) {
      if (!t[o]) {
        var c = 'function' == typeof v && v;
        if (!s && c) return c(o, !0);
        if (a) return a(o, !0);
  ...
  for (var a = 'function' == typeof v && v, o = 0; o < n.length; o++) i(n[o]);
  return i;
})(
  {
    1: [
            ...
            switch (d.browser) {
              case 'chrome':
                if (!i || !i.shimPeerConnection || !t.shimChrome)
                  return (r('Chrome shim is not included in this adapter release.'), p);
              ...
              case 'firefox':
                if (!o || !o.shimPeerConnection || !t.shimFirefox)
                  return (r('Firefox shim is not included in this adapter release.'), p);
              ...
              case 'edge':
                if (!a || !a.shimPeerConnection || !t.shimEdge)
                  return (r('MS edge shim is not included in this adapter release.'), p);
              ...
              case 'safari':
                if (!s || !t.shimSafari)
                  return (r('Safari shim is not included in this adapter release.'), p);
            ...
            if (e.RTCPeerConnection) {
              ...
              e.RTCPeerConnection.prototype.setLocalDescription = function () {
                return arguments.length && arguments[0].type
                  ? ((arguments[0] = u(this, arguments[0])), a.apply(this, arguments))
                  ...
                  Object.keys(e).forEach(function (r) {
                    if ('require' !== r && 'advanced' !== r && 'mediaSource' !== r) {
                      ...
                      void 0 !== n.exact && 'number' != typeof n.exact
                        ? ((t.mandatory = t.mandatory || {}), (t.mandatory[a('', r)] = n.exact))
                        : ['min', 'max'].forEach(function (e) {
                            void 0 !== n[e] &&
                              ((t.mandatory = t.mandatory || {}), (t.mandatory[a(e, r)] = n[e]));
                          });
                    }
                  }),
    ...
    7: [
      function (e, t, r) {
          ...
          (r.shimPeerConnection = function (e) {
            ...
            ((e.RTCPeerConnection = function (e) {
              return (
                e &&
                  e.iceServers &&
                  ((e.iceServers = (0, s.filterIceServers)(e.iceServers, t.version)),
        ...
        var a,
          ...
          c = (a = e('rtcpeerconnection-shim')) && a.__esModule ? a : { default: a };
      },
      {
        '../utils': 15,
        './filtericeservers': 8,
        ...
        n.shimGetUserMedia = function (e) {
          ...
          if (
            ((r.getUserMedia = function (e, t, n) {
              (a.deprecated('navigator.getUserMedia', 'navigator.mediaDevices.getUserMedia'),
            ...
            return (
              ...
              a.forEach(function (t) {
                e.forEach(function (r) {
                  r.type === n && r.trackId === t.id && d(e, r, i);
                });
              }),
              i
            );
                    ...
                    if (!(i.usingBundle && r > 0)) {
                      ...
                      ((p[o.candidate.sdpMLineIndex] += c
                        ...
                        (i._localDescription.sdp =
                          n.getDescription(i._localDescription.sdp) + p.join('')));
            ...
            (p.prototype.setRemoteDescription = function (i) {
              ...
              if (!o('setRemoteDescription', i.type, p.signalingState) || p._isClosed)
                return Promise.reject(
                  c(
                    'InvalidStateError',
                    'Can not set remote ' + i.type + ' in state ' + p.signalingState
                  )
                );
              var u = {};
              ...
              return (
                ...
                l.forEach(function (o, c) {
                  ...
                  if (y || ('application' === l && ('DTLS/SCTP' === g || 'UDP/DTLS/SCTP' === g)))
                    p.transceivers[c] = { mid: T, kind: l, protocol: g, rejected: !0 };
                  else {
                    var P, R, b, w, E, k, _, x, M;
                    !y &&
                      p.transceivers[c] &&
                    ...
                    (y ||
                      ...
                      (_ = n.parseRtpEncodingParameters(o)));
                    ...
                    if (
                      (('offer' === i.type || 'answer' === i.type) &&
                        ...
                        p.transceivers[c].rtpSender &&
                          p.transceivers[c].rtpSender.setTransport(p.transceivers[0].dtlsTransport),
                      ...
                      'answer' !== i.type ||
                        ...
                        (p.transceivers[c].recvEncodingParameters = _),
                        ...
                        !E || ('sendrecv' !== C && 'sendonly' !== C)
                          ...
                          : ((M = E.track),
                            S
                              ? (u[S.stream] || (u[S.stream] = new e.MediaStream()),
                                r(M, u[S.stream]),
                      ...
                      (((P = p.transceivers[c] || p._createTransceiver(l)).mid = T),
                        ...
                        (k = P.sendEncodingParameters || [{ ssrc: 1001 * (2 * c + 2) }]));
                      var G,
                        N = !1;
                      ('sendrecv' === C || 'sendonly' === C
                        ? ((N = !P.rtpReceiver),
                          (E = P.rtpReceiver || new e.RTCRtpReceiver(P.dtlsTransport, l)),
                          N &&
                            ((M = E.track),
                            (S && '-' === S.stream) ||
                              (S
              ...
              return e && void 0 === e.sdpMLineIndex && !e.sdpMid
                ...
                : new Promise(function (i, a) {
                    ...
                    if (e && '' !== e.candidate) {
                      ...
                      if (
                        (0 === o || (o > 0 && p.iceTransport !== r.transceivers[0].iceTransport)) &&
                        !s(p.iceTransport, u)
                      )
                      ...
                      for (
                        ...
                        (r.transceivers[l].rejected ||
                          ...
                          ((t = n.getMediaSections(r._remoteDescription.sdp))[l] +=
                            'a=end-of-candidates\r\n'),
                          (r._remoteDescription.sdp =
                            n.getDescription(r._remoteDescription.sdp) + t.join('')),
                          !r.usingBundle));
        ...
        ((i.localCName = i.generateIdentifier()),
          ...
          (i.writeCryptoLine = function (t) {
            return (
              ...
              t.cryptoSuite +
              ' ' +
              ('object' == e(t.keyParams) ? i.writeCryptoKeyParams(t.keyParams) : t.keyParams) +
            ...
            for (
              ...
              if (o) {
                ...
                switch (
                  ...
                  (s.rtcpFeedback = i.matchPrefix(e, 'a=rtcp-fb:' + a + ' ').map(i.parseRtcpFb)),
                  t.codecs.push(s),
                  s.name.toUpperCase())
                ) {
                  case 'RED':
          ...
          (i.writeMediaSection = function (e, t, r, n) {
            ...
            return (
              (a +=
                'a=ssrc:' + e.sendEncodingParameters[0].ssrc + ' cname:' + i.localCName + '\r\n'),
              e.rtpSender &&
                e.sendEncodingParameters[0].rtx &&
                (a +=
                  'a=ssrc:' +
  ...
  F = (function () {
    function e(t) {
      ...
      (a(this, e),
        C.set(this, void 0),
        S.set(this, void 0),
        o(this, C, new RTCPeerConnection(), 'f'),
        o(this, S, t, 'f'),
        (i(this, C, 'f').onaddstream = function (e) {
          i(r, S, 'f') &&
            Promise.resolve().then(function () {
              var t;
              null === (t = i(r, S, 'f')) || void 0 === t || t.call(r, e);
            });
        }),
        (i(this, C, 'f').ontrack = function (e) {
          i(r, S, 'f') &&
            Promise.resolve().then(function () {
              var t;
              null === (t = i(r, S, 'f')) || void 0 === t || t.call(r, e);
      ...
      t(
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              var e;
              null === (e = i(this, C, 'f')) || void 0 === e || e.close();
            }
          }
        ],
        [
          {
            ...
            value: function (e) {
              var t = (function (e) {
                  ...
                  if ((n = n.replace('...vhost...', '?vhost=')).indexOf('?') >= 0) {
                    var a = n.substr(n.indexOf('?'));
                    ((n = n.substr(0, n.indexOf('?'))),
                      a.indexOf('vhost=') > 0 &&
                        (r = a.substr(a.indexOf('vhost=') + 6)).indexOf('&') > 0 &&
                ...
                o = ''.concat(a).concat(a.lastIndexOf('/') !== a.length - 1 ? '/' : ''),
                s = ''.concat(n, '//').concat(t.server, ':').concat(i).concat(o);
              for (var c in t.user_query)
                'api' !== c && 'play' !== c && (s += '&' + c + '=' + t.user_query[c]);
              return {
...
var z = (function (e) {
  function v() {
    ...
    return (
      ...
      D.set(d(e), !0),
      O.set(d(e), function () {
        (i(d(e), x, 'f') || e.emit(g.play),
          o(d(e), x, !0, 'f'),
          i(d(e), M, 'f') && i(d(e), j, 'f').call(d(e), !1),
          e.emit(g.playing));
      }),
      I.set(d(e), function () {
        (i(d(e), j, 'f').call(d(e), !1), e.emit(g.error));
      }),
      j.set(d(e), function (t) {
        t
          ? (o(d(e), D, !0, 'f'), e.emit(g.waiting))
          : (o(d(e), D, !1, 'f'), clearTimeout(i(d(e), _, 'f')));
      }),
      L.set(d(e), function () {
        o(
          d(e),
          _,
          setTimeout(function () {
            i(d(e), j, 'f').call(d(e), !0);
          }, 300),
          'f'
        );
      }),
      A.set(d(e), function () {
        (i(d(e), j, 'f').call(d(e), !1),
          i(d(e), M, 'f') ||
            (i(d(e), k, 'f') &&
              i(d(e), D, 'f') &&
              (i(d(e), j, 'f').call(d(e), !1), i(d(e), O, 'f').call(d(e)))));
      }),
      G.set(d(e), function () {
        return r(
          d(e),
          ...
          void 0,
          n().mark(function e() {
            var t, r, a, o, s, c, d, f, l, m, h, v, g, C;
            return n().wrap(
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        (h = new F(function (e) {
                          l.then(function (t) {
                            ...
                            e.stream || e.streams[0]
                              ? null === (n = d.resolve) ||
                                void 0 === n ||
                                n.call(d, { stream: e.stream || e.streams[0], sessionid: t })
                              : null === (r = d.reject) ||
                                void 0 === r ||
                        ...
                        h
                          ...
                          .then(function (e) {
                            var t;
                            (p.record(u.info, '[session]', e.sessionid),
                              null === (t = m.resolve) || void 0 === t || t.call(m, e.sessionid));
                          })
                          .catch(function (e) {
                            var t;
                            (p.record(u.error, '[error]', null == e ? void 0 : e.message),
                              h.close(),
                              null === (t = m.reject) || void 0 === t || t.call(m, e));
                          }),
                        (e.next = 8),
                        c
                      );
                    case 8:
                      return (
                        ...
                        (g = v.stream),
                        (C = v.sessionid),
                        e.abrupt('return', { stream: g, sessionid: C, sid: r || '' })
                      );
                    case 12:
                    case 'end':
                      return e.stop();
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      if (
                        (i(this, k, 'f') ||
                          ((a = o(this, k, document.createElement('video'), 'f')).setAttribute(
                          ...
                          a.addEventListener('waiting', i(this, L, 'f')),
                          a.addEventListener('play', i(this, O, 'f')),
                          a.addEventListener('playing', i(this, O, 'f')),
                          a.addEventListener('error', i(this, I, 'f')),
                          a.addEventListener('timeupdate', i(this, A, 'f')),
                          (a.style.objectFit = 'contain'),
                          null === (r = i(this, E, 'f')) || void 0 === r || r.appendChild(a)),
                        i(this, k, 'f') && i(this, E, 'f'))
                      ) {
                        e.next = 3;
                        break;
                      }
                    ...
                    case 3:
                      try {
                        i(this, k, 'f').srcObject = t;
                      } catch (e) {
                        (console.warn('srcObject not supported', null == e ? void 0 : e.message),
                          (i(this, k, 'f').src = window.URL.createObjectURL(t)),
                          window.URL.revokeObjectURL(i(this, k, 'f').src));
                      }
                      return (
                        i(this, R, 'f') && ((i(this, k, 'f').muted = !0), o(this, b, !0, 'f')),
                        (e.next = 7),
                        i(this, k, 'f')
                          .play()
                          .catch(function (e) {
                            return 'NotAllowedError' === (null == e ? void 0 : e.name) &&
                              i(s, k, 'f')
                              ? (s.emit(g.playNotAllowed, f.PlayNotAllowed.code),
                                (s.muted = !0),
                                o(s, P, !0, 'f'),
                                Promise.resolve())
                              : Promise.reject(e);
      ...
      U.set(d(e), function () {
        ...
        var r = i(d(e), k, 'f');
        (r &&
          (r.removeEventListener('waiting', i(d(e), L, 'f')),
          r.removeEventListener('play', i(d(e), O, 'f')),
          r.removeEventListener('playing', i(d(e), O, 'f')),
          r.removeEventListener('error', i(d(e), I, 'f')),
          r.removeEventListener('timeupdate', i(d(e), A, 'f'))),
          null === (t = i(d(e), k, 'f')) || void 0 === t || t.pause(),
          o(d(e), k, void 0, 'f'));
      }),
      e
    );
    ...
    t(v, [
      {
        ...
        get: function () {
          var e = i(this, b, 'f');
          return (i(this, k, 'f') && (e = i(this, k, 'f').muted), e);
        },
        set: function (e) {
          (o(this, b, e, 'f'),
            i(this, k, 'f') &&
      ...
      },
      {
        ...
        set: function (e) {
          (e > 1 && (e = 1), o(this, T, e, 'f'), i(this, k, 'f') && (i(this, k, 'f').volume = e));
        }
      },
      {
        key: 'defaultMuted',
              ...
              return n().wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return ((e.next = 2), i(this, G, 'f').call(this));
                      case 2:
                        return ((t = e.sent), (e.next = 5), i(this, N, 'f').call(this, t.stream));
                      case 5:
                      case 'end':
                        return e.stop();
                    }
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return (
                          i(this, P, 'f') && ((this.muted = !1), o(this, P, !1, 'f')),
                          e.abrupt(
                            'return',
                            i(this, k, 'f')
                              .play()
                              .catch(function (e) {
                                return (p.record(u.warn, '[stream resume]', e), Promise.reject(e));
                              })
                          )
                        );
                      case 3:
      ...
      },
      {
        key: 'stop',
        value: function () {
          (o(this, P, !1, 'f'), this.emit(g.stop), i(this, U, 'f').call(this));
        }
      },
      {
        key: 'setSinkId',
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2),
                          null === (r = i(this, k, 'f')) || void 0 === r ? void 0 : r.setSinkId(e)
                        );
                      case 2:
                      case 'end':
                        return t.stop();
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return e.abrupt(
                          'return',
                          (null === (t = i(this, k, 'f')) || void 0 === t ? void 0 : t.sinkId) || ''
                        );
                      case 1:
                      case 'end':
                        return e.stop();
      ...
      },
      {
        key: 'destroy',
        value: function () {
          (this.stop(), l(m(v.prototype), 'destroy', this).call(this));
        }
      },
...
((T = new WeakMap()),
  ...
  (N = new WeakMap()),
  (U = new WeakMap()));
export { z as WebRTCPlayer, z as default };
